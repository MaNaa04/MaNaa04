...
INFO = [
    ("__header__", "manas pawar", ""),
    ("__rule__", "", ""),
    ("Role",     "Software Engineering Intern @ Ajinkya Infotech", "val"),
    ("Edu",      "B.E. IT, PICT Pune  ·  Class of 2027", "val"),
    ("Focus",    "Backend Engineering  ·  AI Systems / LLMs", "accent"),
    ("__blank__", "", ""),
    ("__section__", "~/stack", ""),
    ("Lang",     "C++ · Java · SQL", "val"),
    ("Backend",  "Spring Boot · Node.js · Express · REST", "val"),
    ("AI",       "LLMs · RAG Pipelines · Chatbots · Prompt Eng", "val"),
    ("Infra",    "Docker · Kafka · Microservices", "val"),
    ("Data",     "PostgreSQL · Redis", "val"),
    ("__blank__", "", ""),
    ("__section__", "~/projects", ""),
    ("TruthLens", "AI hallucination detection · real-time verification", "warn"),
    ("",         "5-layer pipeline · Chrome Extension · LLM eval", "muted"),
    ("Codeon",   "AI-powered repo intelligence · Spring Boot + Kafka", "warn"),
    ("__blank__", "", ""),
    ("__section__", "~/highlights", ""),
    ("Award",    "1st Place · JOSH Softwares Hackathon '26", "val"),
    ("",         "Top 100 · Google GenAI Exchange '25", "muted"),
    ("",         "Rank 44 · Bajaj HackRx '25 · 10K+ teams", "muted"),
    ("__stats__", "", ""),
    ("__blank__", "", ""),
    ("__section__", "~/reach", ""),
    ("In",       "linkedin.com/in/manas-pawar04", "accent"),
    ("LC",       "leetcode.com/u/J9FOqTiYKg", "accent"),
    ("Mail",     "pawarmanas8@gmail.com", "accent"),
]
...
def render(theme_name, colors, stats, ist_now):
    ...
    parts.append(
        ...
        f'<tspan class="key">➜</tspan>'
        f'<tspan class="acc" dx="8">~</tspan>'
        f'<tspan class="val" dx="8">open to Backend · AI · SDE opportunities</tspan>'
